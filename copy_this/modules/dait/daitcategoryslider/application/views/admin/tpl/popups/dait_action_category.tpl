    ...
    initAoc = function()
    {
        ...
        YAHOO.oxid.container1 = new YAHOO.oxid.aoc( 'container1',
                                                    [ [{ foreach from=$oxajax.container1 item=aItem key=iKey }]
                                                      ...
                                                      [{ /foreach }] ],
                                                    '[{ $oViewConf->getAjaxLink() }]cmpid=container1&container=dait_action_category&synchoxid=[{ $oxid }]',
        ...
        YAHOO.oxid.container1.onSave = function()
        {
            ...
            if ( aSelRows.length ) {
                ...
                $('defcat_title').innerHTML  = oParam._oData._0 + ' - ' + oParam._oData._1;
        ...
        YAHOO.oxid.container1.assignCat = function()
        {
            ...
            YAHOO.util.Connect.asyncRequest( 'GET', '[{ $oViewConf->getAjaxLink() }]&cmpid=container1&container=dait_action_category&fnc=assignCat&oxid=[{ $oxid }]'+sRequest, callback );
        ...
        YAHOO.oxid.container1.unassignCat = function()
        {
            ...
            YAHOO.util.Connect.asyncRequest( 'GET', '[{ $oViewConf->getAjaxLink() }]&cmpid=container1&container=dait_action_category&fnc=unassignCat&oxid=[{ $oxid }]', callback );
    ...
    <table width="100%">
        ...
        <tr>
            <td valign="top" class="edittext" id="_defcat" [{if !$defcat }] style="visibility:hidden" [{/if}]>
              <b>[{ oxmultilang ident="DAIT_PROMOTIONS_MAIN_ASSIGNEDDEFAULTCAT" }]</b>
              <b id="defcat_title">[{ $defcat->oxcategories__oxtitle->value }] - [{ $defcat->oxcategories__oxdesc->value }]</b>
            </td>
        </tr>
    </table>
