            ...
            <tr>
              ...
              <td class="edittext">
                <select class="editinput" name="editval[oxactions__oxtype]">
                  ...
                  <option value="9">[{ oxmultilang ident="DAIT_PROMOTIONS_MAIN_TYPE_CATSLIDE" }]</option>
                </select>
              </td>
            </tr>
            [{ /if}]
            ...
            <table cellspacing="0" cellpadding="0" border="0">
                ...
                <tr>
                    <td class="edittext">
                        <table cellspacing="0" cellpadding="0" width="100%" border="0" class="listTable">
                          [{block name="admin_actions_main_product"}]
                            ...
                            [{if $edit->oxactions__oxtype->value == 9 }]
                              ...
                              <tr>
                                <td class="text">
                                    <b>[{ oxmultilang ident="DAIT_PROMOTIONS_BANNER_ASSIGNEDCATEGORY" }]:</b>
                                </td>
                                <td class="text" colspan="2">
                                    <b>
                        ...
                        [{if $edit->oxactions__oxtype->value == 9 }]
                        <input type="button" value="[{ oxmultilang ident="DAIT_PROMOTIONS_MAIN_ASSIGN_CATEGORY" }]" class="edittext" onclick="JavaScript:showDialog('&cl=dait_actions_main&oxpromotionaoc=category&oxid=[{ $oxid }]');" [{ $readonly }]>
                        [{/if}]
